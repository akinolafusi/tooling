...
## Introduction
This is a Dockerfile to BUILD A DEBIANNBCNCBC based container image running nginx and php-fpm 7.3.x / 7.2.x / 7.1.x / 7.0.x & Composer.
...
Create a feature branch. # Always begin with feature/[name of your branch]
```
...
## Push your changes to gitlab, and merge to dev branches..okay
```
...
## If you require permissionspermis  to GCP, or Gitlab resources, please talk to dare@propitix.com
